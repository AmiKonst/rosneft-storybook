const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/search-docs-data-CAXicwle.js","assets/vendor-rawnQjOC.js"])))=>i.map(i=>d[i]);
import { s as ref, n as watch, c as computed, a0 as markRaw, d as defineComponent, e as createElementBlock, o as openBlock, a7 as renderSlot, A as withKeys, x as normalizeClass, C as createBlock, g as unref, I as Icon, j as createVNode, f as createBaseVNode, k as createCommentVNode, D as createTextVNode, y as toDisplayString, F as Fragment, B as renderList, p as useCssVars, a3 as toRefs, a4 as useRouter, v as withCtx, bi as useFocus, bj as refDebounced, w as withDirectives, aj as vModelText, ad as withModifiers, _ as __vitePreload, bk as Fuse } from './vendor-rawnQjOC.js';
import { o as onKeyboardShortcut, u as useCommandStore } from './bundle-main-DZc-obfg.js';
...
import { _ as _export_sfc, u as useScrollOnActive, B as BaseListItemLink } from './responsive-CauMPgd7.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import('./search-docs-data-CAXicwle.js'),true              ?__vite__mapDeps([0,1]):void 0);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
