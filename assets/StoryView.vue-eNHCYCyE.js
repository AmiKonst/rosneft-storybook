import { E as reactive, d as defineComponent, a3 as toRefs, a4 as useRouter, n as watch, s as ref, q as useRoute, c as computed, e as createElementBlock, k as createCommentVNode, C as createBlock, g as unref, v as withCtx, j as createVNode, D as createTextVNode, I as Icon, $ as watchEffect, o as openBlock, a5 as nextTick, h as histoireConfig, a6 as useResizeObserver, z as resolveComponent, a7 as renderSlot, f as createBaseVNode, Q as h, a8 as onBeforeUnmount, a1 as mergeProps, T as Transition, x as normalizeClass, y as toDisplayString, a9 as i0, aa as jm, ab as Gm, ac as Km, r as resolveDirective, w as withDirectives, ad as withModifiers, a2 as resolveDynamicComponent, F as Fragment, B as renderList, ae as kt, af as clone, ag as omit, m as useStorage, L as onMounted, ah as useTimeoutFn, ai as onClickOutside, aj as vModelText, A as withKeys, i as isRef, V as applyState, a0 as markRaw, ak as shallowRef, al as createHighlighter, a as isDark, am as t0, an as unindent, l as defineStore, p as useCssVars, G as normalizeStyle, ao as onUnmounted, ap as createStaticVNode, aq as Ot, u as useEventListener, S as SANDBOX_READY, ar as EVENT_SEND, R as STATE_SYNC, as as toRaw, U as PREVIEW_SETTINGS_SYNC } from './vendor-rawnQjOC.js';
import { u as useStoryStore } from './story-BmNzyU2e.js';
import { _ as _export_sfc, b as BaseSplitPane, u as useScrollOnActive, i as isMobile, B as BaseListItemLink, a as _sfc_main$A } from './responsive-CauMPgd7.js';
import { B as BaseEmpty } from './BaseEmpty.vue-DKaGg5no.js';
import { useEventsStore } from './events-STiuUudv.js';
import { t as toRawDeep, _ as _sfc_main$z, g as getContrastColor } from './state-hAlZpffr.js';
import { c as clientSupportPlugins, b as base } from './mapping-DTmyKjvM.js';
