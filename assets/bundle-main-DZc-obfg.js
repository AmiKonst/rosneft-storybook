const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/SearchPane.vue-CaSXYmiW.js","assets/vendor-rawnQjOC.js","assets/story-BmNzyU2e.js","assets/mapping-DTmyKjvM.js","assets/BaseEmpty.vue-DKaGg5no.js","assets/responsive-CauMPgd7.js"])))=>i.map(i=>d[i]);
import { u as useEventListener, i as isRef, d as defineComponent, c as computed, a as isDark, b as customLogos, h as histoireConfig, e as createElementBlock, o as openBlock, t as toggleDark, r as resolveDirective, f as createBaseVNode, g as unref, j as createVNode, w as withDirectives, k as createCommentVNode, I as Icon, l as defineStore, m as useStorage, n as watch, p as useCssVars, q as useRoute, s as ref, v as withCtx, x as normalizeClass, y as toDisplayString, z as resolveComponent, A as withKeys, F as Fragment, B as renderList, C as createBlock, D as createTextVNode, E as reactive, G as normalizeStyle, T as Transition, H as vShow, J as defineAsyncComponent, _ as __vitePreload, K as useTitle, L as onMounted, M as createApp, N as createPinia, O as Gt } from './vendor-rawnQjOC.js';
import { r as router, f as files, m as mapFile, _ as _sfc_main$c, t as tree } from './mapping-DTmyKjvM.js';
import { u as useStoryStore } from './story-BmNzyU2e.js';
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, a as _sfc_main$b, i as isMobile, b as BaseSplitPane } from './responsive-CauMPgd7.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const SearchPane = defineAsyncComponent({
      loader: () => __vitePreload(() => import('./SearchPane.vue-CaSXYmiW.js'),true              ?__vite__mapDeps([0,1,2,3,4,5]):void 0),
